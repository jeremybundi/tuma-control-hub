  ...
  const HomeDepositsWinners = () => {
    ...
    return (
      <div className="w-full max-w-3xl mx-auto">
        {/* Date Section */}
        <div className="flex items-center p-4 py-3 rounded-lg w-full border border-gray-600 justify-center gap-2 mb-6">
          <Image 
          ...
          />
          <span className="text-white font-outfit text-[13px]">
           ...
           <div className="grid md:grid-cols-[1fr_auto_1fr] p-6 py-3 gap-6 rounded-lg border border-gray-600 mb-6">
            ...
            <div className="flex flex-col justify-center">
              <span className="text-[20px] font-bold text-[#F1B80C] mb-2">52</span>
              <span className="text-gray-300 font-outfit text-[17px]">Total Participants</span>
            </div>
            ...
            {/* Right Column */}
            <div className="flex flex-col font-outfit justify-center space-y-4">
              <div className=" items-center gap-3">
              
                <span className="text-[13px] text-gray-400 font-[400]">
               5 winners to receive     
               
               </span>
               <p className="text-[13px] font-[400] mt-2 text-gray-400">KES 250000</p>
              </div>
        ...
        <div className="mb-6 rounded-xl border border-gray-600 p-6 py-3">
          <div className="space-y-1 max-h-[330px] overflow-y-auto">
            {weeksData.map((weekData) => (
              <div key={weekData.week} className="w-full">
                ...
                {selectedWeek === weekData.week && (
                  <div className="mt-2 p-4 py-2 rounded-lg border border-gray-600 bg-gray-800">
                    <h4 className="text-[#F1B80C] font-outfit text-[16px]">
                      Draw {weekData.week} Winners
                    </h4>
  ...
  export default HomeDepositsWinners;